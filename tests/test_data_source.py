...
class TestDataSource(unittest.TestCase):
    ...
    def test_construct_data_source(self):
        test_ds_zip = DataSource(OSFS("."), "/local/path", "test_id", "http://source/to/file", "test dataset", "zip")

        self.assertEquals("zip",test_ds_zip.compression) 

        test_ds = DataSource(OSFS("."), "/local/path", "test_id", "http://source/to/file", "test dataset")
    ...
    def test_validade_zip_cached(self):
        ...
        test_ds = DataSource(os, "/local/path", "test_id", "http://source/to/file", "test dataset", "zip")
    ...
    def test_zip_download(self):
        test_ds = DataSource(OSFS("."), "/local/path", "test_id", "http://source/to/file", "test dataset", "zip")
        test_ds._download = mock.Mock()
        test_ds.download()
        test_ds._download.assert_called_with("/local/path.zip")

    def test_dont_download_if_cached(self):
        test_online_cached = DataSource(OSFS("."), "/local/path", "test_id", "http://source/to/file", "test dataset", "zip")
    ...
    def test_is_online_source(self):
        test_online = DataSource(OSFS("."), "/local/path", "test_id", "http://source/to/file", "test dataset")
        test_local = DataSource(OSFS("."), "/local/path", "test_id", "./source/to/file", "test dataset")
        self.assertTrue(test_online.is_online_source())
        self.assertFalse(test_local.is_online_source())

    def test_is_ftp_source(self):
        test_online = DataSource(OSFS("."), "/local/path", "test_id", "ftp://source/to/file", "test dataset")
        test_local = DataSource(OSFS("."), "/local/path", "test_id", "./source/to/file", "test dataset")
        self.assertTrue(test_online.is_online_source())
        self.assertFalse(test_local.is_online_source())
    ...
    def test_unzip_local_data(self):
        ...
        test_local = DataSource(os, "/local/path", "train", "./tests/resources/local_data/train.zip", "test dataset", "zip")
